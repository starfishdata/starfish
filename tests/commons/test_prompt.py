...
class TestJinjaPromptManager:
    ...
    def test_conditional_variables(self):
        ...
        # Test rendering with all variables
        result = manager.render_template({"name": "Bob", "show_age": True, "age": 25}).strip()
        assert "Hello, Bob!" in result
        assert "Your age is 25." in result

        # Test rendering with only required variables
        result = manager.render_template({"name": "Charlie", "show_age": False}).strip()
    ...
    def test_nested_conditional_variables(self):
        ...
        result = manager.render_template(
            {"name": "Dave", "show_details": True, "show_age": True, "age": 30, "show_location": True, "location": "New York"}
        ).strip()
        ...
        result = manager.render_template({"name": "Eve", "show_details": True, "show_age": False, "show_location": True, "location": "London"}).strip()
        ...
        result = manager.render_template({"name": "Frank", "show_details": False}).strip()
    ...
    def test_mixed_variables(self):
        ...
        # Test rendering with all variables
        result = manager.render_template({"name": "George", "show_details": True, "details": "Some details"}).strip()
    ...
    def test_complex_templates(self):
        ...
        expected_all = {"condition1", "var1", "nested_condition", "var2", "var3", "condition2", "var4", "var5", "standalone_condition", "var6"}
        expected_req = {"var1"}
        expected_opt = {"condition1", "nested_condition", "var2", "var3", "condition2", "var4", "var5", "standalone_condition", "var6"}
