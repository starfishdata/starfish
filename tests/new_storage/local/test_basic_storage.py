    ...
    try:
        ...
        try:
            await storage.log_execution_job_end(
                job_id, "completed", counts, job_end_time, job_end_time
            )
            print(f"✓ Execution job completed")
        except Exception as e:
        ...
        await storage.log_master_job_end(
            master_job_id, "completed", summary, master_end_time, master_end_time
        )
        print(f"✓ Master job completed")
        ...
        print(f"✓ Execution job verified")
