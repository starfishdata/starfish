...
def get_expected_mandate_vars(required=False):
    ...
    """
    all_mandate_vars = {
        "is_list_input", "list_input_variable", "input_list_length", 
        "schema_instruction", "num_records"
    }
...
def standard_variables():
    ...
    return {
        "name": "Alice", 
        "age": 30, 
        "schema_instruction": "Test schema"
    }
...
class TestPromptManager:
    ...
    @pytest.mark.parametrize("template,template_required,template_optional,test_name", [
    ...
    def test_conditional_variable_analysis(self, template, template_required, template_optional, test_name):
        ...
        if test_name == "basic_conditional":
            ...
            result = manager.render_template({
                "name": "Bob", "show_age": True, "age": 25, "schema_instruction": "Age schema"
            }).strip()
            ...
            # Test hiding age
            result = manager.render_template({
                "name": "Charlie", "show_age": False, "schema_instruction": "No age schema"
            }).strip()
    ...
    def test_complex_templates(self):
        ...
        template_optional = {
            "condition1", "nested_condition", "var2", "var3", 
    ...
    def test_list_input_rendering(self):
        ...
        result = manager.render_template({
            ...
            "schema_instruction": "List schema"
        })
    ...
    def test_num_records_rendering(self):
        ...
        result_default = manager.render_template({
            "topic": "Weather",
            "schema_instruction": "Weather schema"
        })
        assert "You are asked to generate exactly 1 records" in result_default

        # Test custom num_records = 5
        result_custom = manager.render_template({
            "topic": "Cities",
            "schema_instruction": "City schema",
            "num_records": 5
        })
    ...
    def test_get_printable_messages(self):
        ...
        messages = [
            {"role": "user", "content": "Test content line 1\nTest content line 2"},
