...
from starfish.new_storage.base import register_storage
...
register_storage("local", factory_func=lambda config: LocalStorage(
    config.storage_uri,
    getattr(config, "data_storage_uri_override", None)
))
