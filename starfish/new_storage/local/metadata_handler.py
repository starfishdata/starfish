...
from starfish.new_storage.local.setup import initialize_db_schema # Import setup function
...
class SQLiteMetadataHandler:
    ...
    async def _execute_sql(self, sql: str, params: tuple = ()):
        ...
        async with self._write_lock:
            ...
            try:
                ...
                except Exception: pass # Ignore rollback errors after execute error
    ...
    async def save_project_impl(self, project_data: Project):
        ...
        params = (
             ...
             project_data.created_when, project_data.updated_when
        )
    ...
    async def log_master_job_end_impl(self, master_job_id: str, final_status: str, summary: Optional[Dict[str, Any]], end_time: datetime.datetime, update_time: datetime.datetime):
        ...
        """
        params = (
            final_status, end_time, update_time, summary_str,
    ...
    async def list_master_jobs_impl(self, project_id: Optional[str], status_filter: Optional[List[str]], limit: Optional[int], offset: Optional[int]) -> List[GenerationMasterJob]:
    ...
    async def log_execution_job_end_impl(self, job_id: str, final_status: str, counts: Dict[str, int], 
                                        end_time: datetime.datetime, update_time: datetime.datetime, 
        ...
        """
        params = (
            final_status, end_time, update_time, error_message,
    ...
    async def list_execution_jobs_impl(self, master_job_id: str, status_filter: Optional[List[str]] = None, 
                                     limit: Optional[int] = None, offset: Optional[int] = None) -> List[GenerationJob]:
    ...
    async def get_records_for_master_job_impl(self, master_job_id: str, 
                                           status_filter: Optional[List[StatusRecord]] = None,
                                           limit: Optional[int] = None, 
                                           offset: Optional[int] = None) -> List[Record]:
    ...
    async def count_records_for_master_job_impl(self, master_job_id: str,
                                             status_filter: Optional[List[StatusRecord]] = None) -> Dict[str, int]:
        status_clause = ""
        params = [master_job_id]
