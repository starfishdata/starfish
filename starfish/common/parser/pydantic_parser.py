...
class PydanticParser:
    ...
    @staticmethod
    def parse_dict_or_list(data: Union[Dict[str, Any], List[Dict[str, Any]]], 
                   model: Type[BaseModel]) -> Union[BaseModel, List[BaseModel]]:
        """
    ...
    @staticmethod
    def parse_llm_output(text: str, model: Type[BaseModel], 
                      json_wrapper_key: Optional[str] = None,
                      strict: bool = False) -> Optional[Union[BaseModel, List[BaseModel]]]:
        """
    ...
    @staticmethod
    def get_format_instructions(model: Type[BaseModel], 
                                 json_wrapper_key: Optional[str] = None,
